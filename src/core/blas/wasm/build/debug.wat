(module
 ...
 (start $~start)
 (func $assembly/index/modify_array (param $ptr i32) (param $index i32) (param $value i32)
  local.get $ptr
  local.get $index
  i32.const 2
  i32.shl
 ...
 (func $assembly/index/draw (param $val i32) (result i32)
  local.get $val
  return
 )
 (func $assembly/index/int_sqrt (param $val i32) (result i32)
  (local $x f64)
 ...
 (func $assembly/index/drawTexToTex (param $destPtr i32) (param $destWidth i32) (param $srcPtr i32) (param $srcWidth i32) (param $srcHeight i32) (param $destX f32) (param $destY f32)
  (local $y i32)
  (local $x i32)
  (local $x|9 f64)
  (local $targetX i32)
 ...
 (func $assembly/index/arrayFloat32ModifySegment (param $destPtr i32) (param $destIndex i32) (param $srcPtr i32) (param $srcLength i32)
  (local $i i32)
  i32.const 0
  local.set $i
  loop $for-loop|0
 ...
 (func $assembly/index/multiply (param $scalar f32) (param $ptr i32) (param $length i32)
  (local $i i32)
  (local $val f32)
  i32.const 0
  local.set $i
